...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://wise-source-website.vercel.app", "https://main.d28qsol90tm0c9.amplifyapp.com", "https://wise-source.com", "https://www.wise-source.com"],
    allow_methods=["*"],
    allow_headers=["*"],
)
